                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form method="post" action="<?php echo base_url('pj_registrasi/index') ?>" class="user">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?php echo base_url('pj_auth/login') ?>">Sudah punya akun? Silahkan Login</a>
                            </div>
                        </div>
                    </div>
                </div>
